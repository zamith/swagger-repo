...
exports.swaggerEditorMiddleware = function () {
  ...
  router.use('/config/defaults.json', statics(require.resolve('./editor_config.json')));
  router.use('/', statics(Path.dirname(require.resolve('swagger-editor/index.html'))));
...
exports.syncWithSwagger = function (swagger) {
  ...
  updateYaml(mainFile, _.omit(swagger, ['paths', 'definitions']));
}
